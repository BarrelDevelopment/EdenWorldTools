...
func _ready() -> void:
	...
	fileData = FileAccess.get_file_as_bytes("res://1737689872.eden")
	#fileData = FileAccess.get_file_as_bytes("res://1736167506.eden")
	#fileData = FileAccess.get_file_as_bytes("res://1722489989.eden")
